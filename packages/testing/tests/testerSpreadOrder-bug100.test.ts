/**
 * Bug #100 — FusionTester spread-order: action must come AFTER user args
 *
...
import { FusionTester } from '../src/index.js';

describe('Bug #100 — FusionTester spread-order (action after spread)', () => {
    it('discriminator is NOT overridden by user args containing action key', async () => {
        ...
        const tester = new FusionTester(registry, {
